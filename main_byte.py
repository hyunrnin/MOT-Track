...
import cv2
import numpy as np
from for_Byte.byte_tracker2 import BYTETracker  # ByteTrack 모듈 (설치 필요)
import util.module_result as module_result  # 시각화 함수
#gpt version
def process_each_frame(detection_list, byte_tracker, frame):
...
=======
    ...
    detection_list = post_process(YOLO.detect(frame))
    
    process_each_frame(detection_list, byte_tracker, frame)
>>>>>>> 672253a94a3177ea5b3c77f8bff9c144e9e6332b
